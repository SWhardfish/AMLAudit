...
csv_data = {}
csv_file_path = '../FF9SECustomers/25Oct/FF9SECustomerLedgerEntriesLT.csv'
...
input_directory = f'../BGMaxFiles/{year}/{month}/PreProcessed'
# Specify the output directory for updated JSON files
output_directory = f'../BGMaxFiles/{year}/{month}/PreProcessed/InvoiceProcessed'
