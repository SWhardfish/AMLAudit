...
ax1 = sns.barplot(x=list(patterns), y=list(counts), palette="Blues")  # Use a neutral blue palette
...
# Subplot for Code 2
plt.subplot(1, 2, 2)
plt.bar("Total", total_count_code2, color='lightgray')  # Use a light gray color
plt.text(0, total_count_code2 + 10, f"Total: {total_count_code2}", ha='center', fontsize=12)
plt.xlabel("Total")
